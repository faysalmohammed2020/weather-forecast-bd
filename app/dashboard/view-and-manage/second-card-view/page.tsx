          ...
          <div className="p-3 md:p-4 bg-gradient-to-r from-slate-100 to-slate-200 border-b border-slate-300">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
              ...
              <div className="flex flex-col items-center">
                <Label className="text-xs md:text-sm font-medium text-slate-900 mb-1 md:mb-2">DATA TYPE</Label>
              ...
              {/* STATION NO Section */}
              <div className="flex flex-col items-center">
                <div className="text-xs sm:text-sm font-bold uppercase text-slate-600 mb-1 sm:mb-2">STATION NO</div>
              ...
              {/* YEAR Section */}
              <div className="flex flex-col items-center">
                <div className="text-xs md:text-sm font-bold uppercase text-slate-600 mb-1 md:mb-2">YEAR</div>
                <div className="flex">
              ...
              <div className="flex flex-col items-center">
                <div className="text-xs sm:text-sm font-bold uppercase text-slate-600 mb-1 sm:mb-2">STATION</div>
